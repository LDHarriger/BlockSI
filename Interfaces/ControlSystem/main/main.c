                                 ...
                                 char *response, size_t response_size)
{
    ...
    // =========================================================================
        ...
        if (comma) {
            ...
            if (type_len >= sizeof(seq_type)) type_len = sizeof(seq_type) - 1;
            strncpy(seq_type, args, type_len);
            seq_type[type_len] = '\0';
            seq_params = comma + 1;
        } else {
        ...
        // CMD,seq_run
        // Relay prerequisites are handled by the executor itself
        // (parsed from sequence_start params: relay_o2, relay_o3, relay_air)
